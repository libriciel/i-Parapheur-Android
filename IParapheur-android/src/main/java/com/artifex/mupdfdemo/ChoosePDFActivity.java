...
public class ChoosePDFActivity extends ListActivity {
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		if (!Environment.MEDIA_MOUNTED.equals(storageState) && !Environment.MEDIA_MOUNTED_READ_ONLY.equals(storageState)) {
			...
			alert.setButton(
					AlertDialog.BUTTON_POSITIVE, getString(R.string.dismiss), new AlertDialog.OnClickListener() {
		...
		mUpdateFiles = new Runnable() {
			public void run() {
				...
				if (mParent != null) {
					// Adrien
					adapter.add(new ChoosePDFItem(ChoosePDFItem.Type.PARENT, "Parent"));
				}
				for (File f : mDirs)
