			...
			if (Intent.ACTION_VIEW.equals(intent.getAction())) {
				...
				if (uri.toString().startsWith("content://")) {
					...
					if (reason != null) {
						...
						alert.setButton(
								AlertDialog.BUTTON_POSITIVE, getString(R.string.dismiss), new DialogInterface.OnClickListener() {
...
//		startActivityForResult(intent, FILEPICK_REQUEST);
	...
	public void createUI(Bundle savedInstanceState) {
		...
		if (core == null)
			Log.e("Adrien", "CORE NULL");
		else
			Log.i("Adrien", "CORE NOT NULL");
		...
		int smax = (core == null) ? 0 : Math.max(core.countPages() - 1, 1);
		...
		if (isProofing()) {
			...
			int currentPage = getActivity().getIntent().getIntExtra("startingPage", 0);
		...
		mAlertTask = new AsyncTask<Void, Void, MuPDFAlert>() {
			...
			@Override protected void onPostExecute(final MuPDFAlert result) {
				...
				switch (result.buttonGroupType) {
					case OkCancel:
						mAlertDialog.setButton(AlertDialog.BUTTON2, getString(android.R.string.cancel), listener);
						pressed[1] = MuPDFAlert.ButtonPressed.Cancel;
					case Ok:
						mAlertDialog.setButton(AlertDialog.BUTTON1, getString(android.R.string.ok), listener);
						pressed[0] = MuPDFAlert.ButtonPressed.Ok;
						break;
					case YesNoCancel:
						mAlertDialog.setButton(AlertDialog.BUTTON3, getString(android.R.string.cancel), listener);
						pressed[2] = MuPDFAlert.ButtonPressed.Cancel;
					case YesNo:
						mAlertDialog.setButton(AlertDialog.BUTTON1, getString(android.R.string.yes), listener);
						pressed[0] = MuPDFAlert.ButtonPressed.Yes;
						mAlertDialog.setButton(AlertDialog.BUTTON2, getString(android.R.string.no), listener);
	...
	public MuPDFCore openFile(String path) {

		Log.i("Adrien", "OpenFile");

		int lastSlashPos = path.lastIndexOf('/');
		mFileName = new String(
				lastSlashPos == -1 ? path : path.substring(lastSlashPos + 1)
		);
		...
		Log.i("Adrien", "OpenFile ? " + (core != null));
	...
	public void requestPassword(final Bundle savedInstanceState)  {
		...
		alert.setButton(
				AlertDialog.BUTTON_POSITIVE, getString(R.string.okay), new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
		...
		alert.setButton(
				AlertDialog.BUTTON_NEGATIVE, getString(R.string.cancel), new DialogInterface.OnClickListener() {
...
//						getActivity().finish();
	...
	private void reflowModeSet(boolean reflow) {
		mReflow = reflow;
		mDocView.setAdapter(mReflow ? new MuPDFReflowAdapter(getActivity(), core) : new MuPDFPageAdapter(getActivity(), this, core));
