...
public class RESTClientAPI1 extends RESTClientAPI {
	...
	public String createAnnotation(@NonNull String dossierId, @NonNull String documentId, @NonNull Annotation annotation, int page) throws IParapheurException {
		...
		try {
			...
			annot.put("dossier", "workspace://SpacesStore/" + dossierId).put("annotations", new JSONArray().put(new JSONObject().put("author", annotation.getAuthor()).put("page", page).put("rect", rect).put("text", annotation.getText()).put("type", "rect")));
		}
	...
	public void updateAnnotation(@NonNull String dossierId, @NonNull String documentId, @NonNull Annotation annotation, int page) throws IParapheurException {
		...
		try {
			...
			annot.put("dossier", "workspace://SpacesStore/" + dossierId).put("annotation", new JSONObject().put("uuid", annotation.getUuid()).put("rect", rect).put("text", annotation.getText()));
		}
		catch (JSONException e) {
