...
public class AccountsRepository
{
    ...
    public List<Account> all()
    {
        ...
        editor.putString( PREFS_PREFIX + "AccountTest1" + PREFS_LOGIN_SUFFIX, "john.doe@montpellier-agglo.com" );
        ...
        editor.putString( PREFS_PREFIX + "AccountTest2" + PREFS_LOGIN_SUFFIX, "john.doe@montpellier.fr" );
        ...
        editor.putString( PREFS_PREFIX + "AccountTest3" + PREFS_LOGIN_SUFFIX, "john.doe@laregion.fr" );
